...
void AnimManager::CreateDebugAnim() {
	...
	for (auto anim : anim_) {
		...
		anim->regist(100, 100, "anim_debuff", "graphics/effect/card_anim/anim_debuff.png", tnl::SeekUnit::ePlayMode::SINGLE, 0.5f, 20, 192, 0, 4);
		anim->regist(100, 100, "anim_crow", "graphics/effect/card_anim/anim_crow.png", tnl::SeekUnit::ePlayMode::SINGLE, 1.0f, 10, 240, 0, 2);
