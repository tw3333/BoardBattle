...
public:
	...
	std::shared_ptr<AnimSprite3D>& GetObjBattleStateAnim() { return obj_battle_state_anim_; }
...
private:
	...
	std::shared_ptr<AnimSprite3D> obj_battle_state_anim_ = nullptr; //BattleStateAnim再生用のObj
