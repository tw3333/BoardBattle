...
void CardRangeUpperLeft::DisplayRange(UnitAlly* act_ally, Board* board)
{
}

std::vector<Unit*> CardRangeUpperLeft::GetUnitInRange(UnitAlly* act_ally, std::vector<Unit*> all_units)
{
    return std::vector<Unit*>();
}

std::vector<SquarePos> CardRangeUpperLeft::GetRangeSquarePos(SquarePos axis_pos)
{
