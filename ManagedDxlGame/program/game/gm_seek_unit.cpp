#include "gm_seek_unit.h"


//-------------------------------------------------------------------------------------------------------
void TestSeekUnit::restart() {
...
//-------------------------------------------------------------------------------------------------------
void TestSeekUnit::jumpSeekRate(const double seek_rate) {
	seek_position_ = total_time_ * seek_rate;
	seek_position_ = std::clamp<double>(seek_position_, 0, total_time_);
}

//-------------------------------------------------------------------------------------------------------
void TestSeekUnit::jumpSeekFrame(uint32_t frame) {
...
//-------------------------------------------------------------------------------------------------------
void TestSeekUnit::update(const double delta_time) {
...
//-------------------------------------------------------------------------------------------------------
void TestSeekUnit::setFrameTriggerFunction(const uint32_t& frame, std::function<void()> func) {
	if (frame_functions_storage_.empty()) return;
...
//-------------------------------------------------------------------------------------------------------
void TestSeekUnit::setPlayState(const ePlayMode& play_mode, const ePlayDir& play_dir) {
	play_dir_ = play_dir;
...
//-------------------------------------------------------------------------------------------------------
void TestSeekUnit::seekProcess(const float delta_time) {
...
//-------------------------------------------------------------------------------------------------------
void TestSeekUnit::setTotalFrameNum(const uint32_t frame_num) {
	if (0 == frame_num) {
...
//-------------------------------------------------------------------------------------------------------
double TestSeekUnit::getSeekRateInFrame() {
...
//-------------------------------------------------------------------------------------------------------
uint32_t TestSeekUnit::getSeekFrame(const eFrameType& e_frame) {
